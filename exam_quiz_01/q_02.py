...
plt.plot( rs ,dm_01 ,'.',color ='teal'    ,zorder = 1)
plt.plot(rs, dm_02,'.m' ,color='indigo', zorder =2)
plt.plot(rs, dm_03,'.',color='firebrick' , zorder =2)
...
plt.errorbar(rs ,del_03 , yerr=dm_err , fmt='.r', ecolor='r' ,elinewidth=0.5)
